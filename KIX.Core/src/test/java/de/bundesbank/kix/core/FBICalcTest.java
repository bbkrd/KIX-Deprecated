...
public class FBICalcTest {
    ...
    private static final double[] DATA1 = {103.99467, 106.39148, 106.12517, 108.25566, 105.90406, 109.71710, 111.68512, 113.65314,
    ...
    private static final TsData A = new TsData(TsFrequency.Quarterly, 2008, 0, DATA1, true);

    private static final double[] WEIGHT1 = {455.0, 443.0, 431.0, 419.0, 408.0, 380.0, 352.0, 324.0, 290.0, 313.0, 336.0, 359.0,
                                             395.6, 387.0, 378.4, 369.8, 368.5, 350.0, 331.5, 313.0, 290.9, 311.8, 306.8, 301.8};
    private static final TsData WEIGHTS_FOR_A = new TsData(TsFrequency.Quarterly, 2008, 0, WEIGHT1, true);

    private static final double[] DATA2 = {99.64912, 99.82456, 98.07018, 96.66667, 98.45735, 96.91470, 95.37205, 93.82940, 99.12959,
    ...
    private static final TsData B = new TsData(TsFrequency.Quarterly, 2008, 0, DATA2, true);

    private static final double[] WEIGHT2 = {176.0, 181.0, 186.0, 191.0, 195.0, 230.0, 265.0, 300.0, 366.0, 380.0, 394.0, 408.0,
                                             430.5, 463.0, 495.5, 528.0, 558.0, 576.0, 594.0, 612.0, 648.6, 672.3, 698.0, 723.7};
    private static final TsData WEIGHTS_FOR_B = new TsData(TsFrequency.Quarterly, 2008, 0, WEIGHT2, true);

    @Test
    public void testAdd_TsData_TsData() {
        TsData indexSeriesTwo = B;
        TsData weightSeriesTwo = WEIGHTS_FOR_B;
        FBICalc instance = new FBICalc(A, WEIGHTS_FOR_A);
        instance.plus(indexSeriesTwo, weightSeriesTwo);
    ...
    public void testAdd_TsData_double() {
        ...
        instance.plus(indexSeriesTwo, weightTwo);
    ...
    public void testAdd_TsData_TsData_NoIntersection() {
        TsData indexSeriesTwo = B;
        TsData weightTwo = WEIGHTS_FOR_B;
